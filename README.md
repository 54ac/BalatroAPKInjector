...
This is a simple Python script that injects the Android build of [Lovely](https://github.com/kodenamekrak/lovely-injector) to the retail APK of Balatro, adding mod support to the game.
